              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-3 text-blue-700">
                    ...
                    <h3 className="text-lg font-bold tracking-tight" style={{ fontFamily: 'var(--font-heading), Inter, sans-serif' }}>
                      {title}
                    </h3>
                  </div>
                  <button 
                ...
                <div className="text-sm text-gray-600 leading-relaxed" style={{ fontFamily: 'Inter, system-ui, sans-serif' }}>
                  {content}
                </div>
